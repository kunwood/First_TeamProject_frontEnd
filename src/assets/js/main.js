export default function initMain() {
  // TODO : 캐러셀 아이콘
  // const nextIcon = '<img src={require("../images/left-arrow.png")} alt:"left">'
  // const prevIcon = '<img src={require("../images/right-arrow.png")} alt:"right">'
  ...
  $(function () {
        ...
        onInitialize: function () {
          setTimeout(function () {
            ...
            tl.set(
              ...
              { y: "100%", transformStyle: "preserve-3d" }
            )
    ...
    $(".owl-carousel").owlCarousel({
      ...
      items: 1,
      navText: [
        "<img src=" + require("../images/left-arrow_1.png") + ">",
        "<img src=" + require("../images/right-arrow_1.png") + ">",
      ],
    });
    ...
    //   $("Link[name='roomDetail']").click(function () {
    //     $("aria-hidden").false();
    //   })
    // })
    ...
    // $(document).on('click', '.modalRoom', function(){
    //   $(".modal-backdrop").fade(hide);
    // })
    
    // $("Link.modalRoom").click(function(){
    //   $('#myModal').modal('hide')
    //   });
  ...
  //   $("#myBtn").click('hide.bs.modal', function() {
  //       $("#myModal").modal("hide");
  //   });

  //   $("#myBtn").click('data-dismiss', function(){});
  // })
