              ...
              <div class="row swiper-all">
                ...
                >
                  <Swiper
                      ...
                      className="rdSwiper"
                    >
                      <SwiperSlide className="stand1"></SwiperSlide>
                      <SwiperSlide className="stand2"></SwiperSlide>
                      <SwiperSlide className="stand3"></SwiperSlide>
                      <SwiperSlide className="stand4"></SwiperSlide>
                    </Swiper>
                  <Swiper
