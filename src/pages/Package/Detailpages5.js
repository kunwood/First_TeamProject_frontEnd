...
import "../../assets/css/detailpages5.css";
        ...
        <div class="untree_co--site-wrap">
          ...
          <main class="untree_co--site-main">
            ...
            >
              ...
              <div id="myback5">
                <div class="main-text">
                  <h1 id="main-text1">PARTY ROOM</h1>
                  <br />
                </div>
              </div>
              {/* 타이틀 끝 */}
          ...
          <div class="detail-main5">
            <div id="partymain">
              <div class="partyimg">
                <img
                  src={require("../../assets/images/DetailImages/party.jpg")}
                  class="wow fadeInLeft"
                  data-wow-delay="1s"
                  data-wow-duration="2s"
                ></img>
                <img
                  src={require("../../assets/images/DetailImages/party2.jpg")}
                  class="partyimg1 wow fadeInRight"
                  data-wow-delay="1s"
                  data-wow-duration="2s"
                ></img>
              </div>
              <div class="partyimg wow slideInUp" data-wow-delay="0.5s">
                <img
                  src={require("../../assets/images/DetailImages/party3.jpg")}
                ></img>
              </div>
              <div class="partyimg">
                <img
                  src={require("../../assets/images/DetailImages/party4.jpg")}
                  class="wow fadeInLeft"
                  data-wow-delay="1s"
                  data-wow-duration="2s"
                ></img>
                <img
                  src={require("../../assets/images/DetailImages/party5.jpg")}
                  class="partyimg2 wow fadeInRight"
                  data-wow-delay="1s"
                  data-wow-duration="2s"
                ></img>
              </div>
